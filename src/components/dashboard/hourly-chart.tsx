...
import { fmt, startOfWeek } from "@/lib/utils";
    ...
    <Card className="animate-fade-in">
      <CardHeader className="flex-col items-stretch gap-2">
        ...
        <div className="flex flex-wrap items-center gap-1.5 text-[10px] text-muted-foreground">
          ...
          <button onClick={() => { setFrom(startOfWeek(today)); setTo(today); }} className="rounded-md border border-border px-1.5 py-1 transition-colors hover:text-foreground" title="sejak Senin minggu ini">Minggu ini</button>
